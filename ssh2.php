...
$pf=sys_get_temp_dir().'/ssh_askpass2.bat';
...
$cmd = $mode==='scp' ? 'scp -P 65002 '.$base.' '.escapeshellarg($argv[2]).' u368322281@141.136.39.89:'.escapeshellarg($argv[3]) : 'ssh -p 65002 '.$base.' u368322281@141.136.39.89 '.escapeshellarg($argv[2]??'echo OK');
