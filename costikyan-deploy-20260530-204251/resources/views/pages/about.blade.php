...
<section style="background:#111111;" x-data="{ era: 0 }">
    <div class="max-w-[1100px] mx-auto px-6 py-16">
        ...
        @php
        $eras = [
            ['year'=>'1880','title'=>'Origins in Constantinople','desc'=>'The Costikyan family\'s roots trace back to Constantinople, where generations were deeply involved in the traditional rug trade, developing expertise passed down through family lineage.'],
            ['year'=>'1900','title'=>'Arriving in America','desc'=>'After immigrating to New York, Costikyan expanded his business to serve the growing American market, bringing Old World craftsmanship to a new continent.'],
            ...
            ['year'=>'1980','title'=>'Design Evolution','desc'=>'The company embraced contemporary design movements while maintaining its handcrafted traditions, collaborating with leading interior designers and architects.'],
            ...
            ['year'=>'2025','title'=>'Custom by Design','desc'=>'Today, every rug we make starts with a conversation. Our custom rug programme — from blank canvas to finished piece — has become the cornerstone of our business.'],
        ];
        @endphp
