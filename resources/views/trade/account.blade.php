...
<div class="max-w-[720px] space-y-5">
    ...
    <div class="bg-white border border-stone-200 rounded-lg overflow-hidden">
        ...
        <div class="px-6 py-4 flex items-center gap-4" style="border-bottom:1px solid rgba(18,18,18,0.06);">
            ...
            <a href="{{ route('profile.show') }}" style="font-size:13px; font-weight:500; color:#B8860B;" class="hover:underline flex-shrink-0">Edit</a>
        </div>
        @endforeach
    </div>
    ...
    <div class="bg-white border border-stone-200 rounded-lg overflow-hidden">
        ...
        @if($addresses->count())
            ...
            <div class="px-6 py-5 {{ !$loop->last ? 'border-b border-stone-100' : '' }}">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p style="font-size:14px; font-weight:500; color:#121212;" class="mb-1">{{ $addr->full_name }} {{ $addr->is_default ? '(Default)' : '' }}</p>
        ...
        <div class="px-6 py-8 text-center">
            <p style="font-size:14px; color:rgba(18,18,18,0.55);">No saved addresses. Add one from your <a href="{{ route('profile.show') }}" style="color:#B8860B; font-weight:500;">profile settings</a>.</p>
        </div>
        @endif
    </div>
    ...
    <div class="bg-white border border-stone-200 rounded-lg overflow-hidden">
        <div class="px-6 py-5 flex items-center gap-4">
            ...
            <div>
                ...
                <p style="font-family:'Lusitana',serif; font-size:18px; font-weight:700; color:#121212;">Trade — {{ $user->trade_discount }}% Off MSRP</p>
            </div>
        </div>
    </div>
