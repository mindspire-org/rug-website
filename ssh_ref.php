...
$pf=sys_get_temp_dir().'/ssh_askpass_ref.bat';
...
$cmd = $mode==='scp' ? 'scp -P 65002 '.$base.' '.escapeshellarg($argv[2]).' u714104226@82.112.252.128:'.escapeshellarg($argv[3]) : 'ssh -p 65002 '.$base.' u714104226@82.112.252.128 '.escapeshellarg($argv[2]??'echo OK');
